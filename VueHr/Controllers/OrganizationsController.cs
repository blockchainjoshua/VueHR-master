...
namespace VueHr.Controllers
{
    public class OrganizationsController : Controller
    {
        ...
        public OrganizationsController(VueHrContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Address,Phone,Email,OperatingHours")] Organization organization)
        {
